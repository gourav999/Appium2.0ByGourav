...
public class DragAndDrop {
    ...
    public void dragAndDrop() throws InterruptedException {
        ...
        WebElement ele = driver.findElement(AppiumBy.androidUIAutomator("new UiSelector().text(\"Drag\")"));
        ...
        WebElement target = driver.findElement(AppiumBy.androidUIAutomator("new UiSelector().className(\"android.view.ViewGroup\").instance(14)"));
        WebElement source = driver.findElement(AppiumBy.androidUIAutomator("new UiSelector().className(\"android.widget.ImageView\").instance(1)"));
        ...
        dragAndDrop.addAction(finger.createPointerMove(Duration.ofMillis(1000), PointerInput.Origin.viewport(),
...
////}*/
    ...
    //Swipe from chatgpt
    @Test(enabled = true)
    public void swipefromChatgpt() throws InterruptedException {

        System.out.println("-------------Clicking on swipe and swipting right to left-----------------");
        WebElement ele = driver.findElement(AppiumBy.androidUIAutomator("new UiSelector().text(\"Webview\")"));
        boolean activityTabeEnabled = ele.isDisplayed();
        Assert.assertTrue(activityTabeEnabled, "Swipe should be enabled and displayed");
        if (activityTabeEnabled != false) {
            ele.click();
        ...
        System.out.println("THis is screen width==>"+startX);
        int startY = (int) (screenHeight * 0.8); // 80% of the screen height (near the bottom)
        System.out.println("THis is screenHeighth near the bottom==>"+startY);
        int endY = (int) (screenHeight * 0.2); // 20% of the screen height (near the top)
        System.out.println("THis is screen height near the top==>"+endY);
